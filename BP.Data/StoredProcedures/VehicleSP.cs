...
namespace BP.StoredProcedures
{
    public class VehicleSP
    {
        ...
        {
            return await BPContext.Customers.FromSqlRaw($"EXECUTE {VehicleSPDefinitions.AddVehicle} \'{vehicle.VehicleID}\', \'{vehicle.Type}\', \'{vehicle.NumberPlate}\', \'{vehicle.Colour}\', \'{vehicle.AdultSeats}\', \'{vehicle.InfantSeats}\', \'{vehicle.BootCapacity}\', \'{vehicle.IsShared}\'").AnyAsync();
        }
